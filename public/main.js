...
function storeTheme(themeName) {
  ...
  // Function for parsing the webpage's cookie string into a JavaScript object;
  ...
  function clearTheme() {
    // Your code here
    document.cookie = "themeName=; expires=00:00:00";
  }
/* ================================ PHASE 3 ================================ */
...
function restoreName() {
    ...
    .split("; ")
    .find(pairString => pairString.startsWith("displayName="));
